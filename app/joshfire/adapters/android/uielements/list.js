...
Joshfire.define(['../../../uielements/list', 'joshfire/class', 'joshfire/utils/grid', 'joshfire/vendor/underscore', 'joshfire/vendor/iscroll', 'joshfire/vendor/zepto'], function(List, Class,Grid, _, iScroll, $) {
  /**
